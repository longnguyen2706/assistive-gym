...
from assistive_gym.envs.urdf.urdf_name_resolver import get_urdf_folderpath, get_urdf_ref_filepath
...
if __name__ == "__main__":
    ...
    parser.add_argument('--smpl-file',
                        default='/nethome/nnagarathinam6/Documents/joint_reaching_evaluation/BodyPressureTRI/networksscan7.pkl',
