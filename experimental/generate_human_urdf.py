...
def generate_urdf(args):
    ...
    generate_human_mesh(physic_client_id, urdf_ref_file, urdf_folder, args.smpl_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--person-id', default='p005', help='Person id')
    parser.add_argument('--smpl-file', default='examples/data/fits/p005/s01.pkl',
